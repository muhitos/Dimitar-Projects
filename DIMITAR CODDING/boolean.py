...
# name_of_school =  input()
# if name_of_school == 'SoftUni_Basic'or name_of_school == 'Soft':
#     name_of_course = input('Name of course: ')
#
#     if name_of_course == 'basic':
#         print('Hello Softuni Basic')
#     else:
#         print('error')
